...
# It happens because SVM loss is a rectified function and when we are at the hinge for some class a slight nudge in the singe W entry can move us from the slope to flat and this will change numerical gradient.  
# 
